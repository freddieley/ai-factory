...
const schema = z.object({
  ...
  MAX_AGENT_STEPS: z.coerce.number().int().min(1).default(12),
  MAX_MODEL_CALLS: z.coerce.number().int().min(1).default(4),
  MAX_TOOL_CALLS: z.coerce.number().int().min(1).default(30),
  MAX_RUN_MS: z.coerce.number().int().min(5_000).default(120_000),
  MODEL_TIMEOUT_MS: z.coerce.number().int().min(1_000).default(60_000),
  PLANNER_TIMEOUT_MS: z.coerce.number().int().min(1_000).default(20_000),
  TOOL_TIMEOUT_MS: z.coerce.number().int().min(1_000).default(30_000),
