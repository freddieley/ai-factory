...
describe("robot agent prompt integrity", () => {
  ...
  it("describes the generic model/compiler boundary", () => {
    ...
    expect(source).toContain("For subtractive holes in an existing extrusion, use the generic circle-on-extrude cut semantics.");
